...
use App\Http\Controllers\Admin\DeviceExportController;
...
//Upload csv
Route::get('/allBrands', [UploadCsvController::class, 'index'])->name('device.index');
Route::get('/uploadcsv', [UploadCsvController::class, 'create'])->name('device.csv');
Route::post('/upload/device/csv', [UploadCsvController::class, 'store'])->name('csv.import');

//Export csv
Route::get('export/csv', [DeviceExportController::class, 'deviceExport'])->name('device.export');