                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="p-1">
                                                                <form action="<?php echo e(route('editseries',$serie->id)); ?>" method="post"enctype="multipart/form-data">
                                                                    <?php echo csrf_field(); ?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea class="summernote" name="SeriesDescription"><?php echo $serie->SeriesDescription; ?></textarea>
                                                                    </div>

                                                                    <div class="form-group">
                                                                        <label for="">Series Image<span class="text-danger">*</span></label>
                                                                        <input type="file" name="image" class="form-control" value="<?php echo e($serie->image); ?>">
                                                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/waqrhafeez/smartstation.focusdmt.com/resources/views/Dashboard/ModalSeries/modalseries.blade.php ENDPATH**/ ?>