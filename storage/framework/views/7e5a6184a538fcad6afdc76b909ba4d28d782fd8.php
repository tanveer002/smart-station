                            ...
                            <table class="table table-hover  m-0" width="918px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($issue->model_name); ?></td>
                                        <td><?php echo e($issue->IssueDescription); ?></td>
                                        <td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="p-1">
                                                                <form action="<?php echo e(route('editissue',$issue->id)); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>

                                                                    <div class="form-group">
                                                                        <label for="ServiceTitle">Modal Name<span class="text-danger">*</span></label>
                                                                        <select class="form-control" name="model_name" id="model_id" onchange="updateDeviceIdByName(this.id)">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="IssueDescription" parsley-trigger="change" required class="form-control"></textarea>
                                                                    </div>
...
<?php echo $__env->make('Dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Larvel Project\MobileRepairing\resources\views/Dashboard/Issues/issues.blade.php ENDPATH**/ ?>