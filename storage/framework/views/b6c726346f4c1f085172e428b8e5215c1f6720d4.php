...
<html>
  <head>
    ...
    <script id="locator-result-items-tmpl" type="text/x-handlebars-template">
      <?php echo e(#each locations); ?>

        <li class="location-result" data-location-index="<?php echo e(index); ?>">
          <button class="select-location">
            <h2 class="name"><?php echo e(title); ?></h2>
          </button>
          <div class="address"><?php echo e(address1); ?><br><?php echo e(address2); ?></div>
          <button class="details-button">
            View details
          </button>
          <?php echo e(#if travelDistanceText); ?>

            <div class="distance"><?php echo e(travelDistanceText); ?></div>
          <?php echo e(/if); ?>

          <?php echo e(#if ../showDirectionsButton); ?>
    ...
    <script id="locator-details-tmpl" type="text/x-handlebars-template">
      ...
      <header>
        ...
        <h2><?php echo e(location.title); ?></h2>
      </header>
      <?php echo e(#if location.travelDistanceText); ?>

        <div class="distance"><?php echo e(location.travelDistanceText); ?> away</div>
      <?php echo e(/if); ?>

      <div class="address">
        <?php echo e(location.address1); ?><br>
        <?php echo e(location.address2); ?>

      </div>
      <div class="atmosphere">
        <?php echo e(#if place.rating); ?>

          <span class="star-rating-numeric"><?php echo e(place.rating); ?></span>
          <span>
            <?php echo e(#each place.fullStarIcons); ?>

              <img src="https://fonts.gstatic.com/s/i/googlematerialicons/star/v15/24px.svg"
                   alt="" class="star-icon"/>
            <?php echo e(/each); ?>

            <?php echo e(#each place.halfStarIcons); ?>

              <img src="https://fonts.gstatic.com/s/i/googlematerialicons/star_half/v17/24px.svg"
                   alt="" class="star-icon"/>
            <?php echo e(/each); ?>

            <?php echo e(#each place.emptyStarIcons); ?>
        ...
        <?php echo e(#if place.user_ratings_total); ?>

          <a href="<?php echo e(place.url); ?>" target="_blank"><?php echo e(place.user_ratings_total); ?> reviews</a>
        <?php echo e(else); ?>

          <a href="<?php echo e(place.url); ?>" target="_blank">See on Google Maps</a>
        <?php echo e(/if); ?>

        <?php echo e(#if place.price_level); ?>

          &bull;
          <span class="price-dollars">
            <?php echo e(#each place.dollarSigns); ?>$<?php echo e(/each); ?>
      ...
      <hr/>
      <?php echo e(#if place.opening_hours); ?>
        ...
        <div class="hours contact">
          ...
          <div class="right">
            <?php echo e(#each place.openingHoursSummary); ?>

              <div>
                <span class="weekday"><?php echo e(days); ?></span>
      ...
      <?php echo e(#if place.website); ?>
        ...
        <div class="website contact">
          ...
          <div class="right">
            <a href="<?php echo e(place.website); ?>"><?php echo e(place.websiteDomain); ?></a>
          </div>
        </div>
      <?php echo e(/if); ?>

      <?php echo e(#if place.formatted_phone_number); ?>

        <div class="phone contact">
          <img src="https://fonts.gstatic.com/s/i/googlematerialicons/phone/v10/24px.svg"
               alt="Phone number" class="icon"/>
          <div class="right">
            <?php echo e(place.formatted_phone_number); ?>

          </div>
        </div>
      <?php echo e(/if); ?>

      <?php echo e(#if place.html_attributions); ?>

        <?php echo e(#each place.html_attributions); ?>

          <p class="attribution"><?php echo e(this); ?></p>
        <?php echo e(/each); ?>
...
</html><?php /**PATH C:\xampp\htdocs\MobileRepairing\resources\views/Frontend/storelocator.blade.php ENDPATH**/ ?>