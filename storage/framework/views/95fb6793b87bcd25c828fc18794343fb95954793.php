                ...
                <div class="colums">
                    ...
                    <div class="item">
                        ...
                        <select class="form-control" name="shop">
                            ...
                            <?php $__currentLoopData = App\Models\Store::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($store->id); ?>"><?php echo e($store->StoreName); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <input type="hidden" name="email" value="<?php echo e($store->StoreEmail); ?>">
                    </div>
                    <div class="item">
...
<?php echo $__env->make('Frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/waqrhafeez/smartstation.focusdmt.com/resources/views/Frontend/bookingForm.blade.php ENDPATH**/ ?>