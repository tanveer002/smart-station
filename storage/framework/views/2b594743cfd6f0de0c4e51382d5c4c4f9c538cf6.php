                    ...
                    <div class="col-12">
                        <div class="p-1">
                            <form action="<?php echo e(route('saveservice')); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="ServiceDescription">Service Description<span class="text-danger">*</span></label>
                                    <textarea id="summernote" name="ServiceDescription" parsley-trigger="change" required class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('Dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Larvel Project\MobileRepairing\resources\views/Dashboard/services/services.blade.php ENDPATH**/ ?>