<script>
    ...
    function initMap() {
        ...
        map.data.setStyle((feature) => {
            return {
                icon: {
                    url:'<?php echo e(asset('')); ?>frontend/image/icon_${feature.getProperty('+category+')}.png',
      ...
      <img style="float:left; width:200px; margin-top:30px" src="<?php echo e(asset('')); ?>frontend/image/logo_${category}.png">
...
<?php /**PATH C:\focus\MobileRepairing\resources\views/Frontend/map.blade.php ENDPATH**/ ?>