            ...
            <ul>
                ...
                <li data-index="rs-01" data-transition="fade" data-slotamount="default" data-easein="Power100.easeIn" data-easeout="Power100.easeOut" data-masterspeed="2000" data-fsmasterspeed="1500" data-param1="01">
                    ...
                    <div class="tp-caption tp-resizeme rs-parallaxlevel-3"
                         ...
                         data-responsive_offset="on" data-start="1000"
                         data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","speed":2000,"to":"o:1;","delay":1500,"ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]'>
                        <h1 class="text-white main-font text-capitalize slider_text"><span class="font-weight-200"><?php echo e($slider->subtitle); ?></span>
                        </h1>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <a href="" class="btn btn-primary  btn-lg">Take My Device For Repair</a></center>
            </div>
        </div>
        <br>
        <div class="row">
    ...
    <div class="container">
        <div class="row wow fadeInUp" data-wow-delay="100ms">
            <div class="col-12 text-center">
                <p class="text-blue text-lg" style="text-transform: capitalize;font-family: 'Roboto',Helvetica,Arial,Lucida,sans-serif;font-weight: 700;font-size: 37px;color: #00a9e4">Device Pick-Up And Drop-Off Service</p>
            </div>
        </div>
        <br>
        <div class="row">
           <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-12 col-sm-12 price-green wow fadeInLeft" data-wow-delay="300ms">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p style="text-align: justify;"><?php echo e($service->ServiceDescription); ?></p>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <p style="text-align:center;padding-bottom: 1em;">
                Here at <b>Smart Station</b>, we understand how much you value your electronic devices and that accidents do happen. Out of passion and experience, our brand was built to help you get the most out of your personal and professional devices. Over the years, we have continued to show our unwavering commitment to quality customer care. Whether your device has an <strong>iPhone Repair Services</strong> cracked screen, isn’t holding a charge or is simply dead, you can always count on us. This is because we have the parts, tools, knowledge, and experience for fast and high-quality repairs.
            </p>
            <center><a href="" class="btn btn-md" style="background-color: #00A9E3;color: white;vertical-align: middle;padding-top: 5px;s">Read More</a></center>
            <br>
        </div>
        ...
        <div class="col-md-4 col-sm-12">
            <div class="about-box active center-block bg-blue wow zoomIn" data-wow-delay="500ms">
                <div class="about-main-icon pb-4 rotate">
                    <img src="<?php echo e(asset('frontend/image/RepairService')); ?>/<?php echo e($repair->image); ?>"/>
                </div>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Sydeny</a>
            <br><br>
        </div>
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Melbourne</a>
        </div>
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Brisbane</a>
        </div>
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Newcastle</a>
        </div>
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Canberra</a>
        </div>
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Perth</a>
        </div>
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Logan City</a>
        </div>
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Mackay</a>
        </div>
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Cairns</a>
        </div>
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Parramatta</a>
        </div>
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Gold Coast</a>
        </div>
        <div class="col-lg-2 col-sm-12">
            <a href="" type="button" class="btn" style="background-color: #00a9e4!important;color: white;width: 200px;max-width: 100%;border-color: rgba(0,0,0,0);border-radius: 50px;">Ballarat</a>
        </div>
    </div>
</div>
<br><br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Larvel Project\MobileRepairing\resources\views/Frontend/index.blade.php ENDPATH**/ ?>