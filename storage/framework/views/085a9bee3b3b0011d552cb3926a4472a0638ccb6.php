    ...
    <div class="testbox">
        <form id="save_booking">
            ...
            <fieldset>
                ...
                <input type="hidden" name="selected_issues" value="<?php echo e($issue_name); ?>">
                <div class="colums">
                    ...
                    <div class="item hidden">
                        ...
                        <?php $__currentLoopData = $issues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><input type="text" name="issue_names" placeholder="Issue Name" readonly
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $('#save_booking').submit(function (e) {
            ...
            $.ajax({
                url: '<?php echo e(url('savebooking')); ?>',
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
...
<?php echo $__env->make('Frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/waqrhafeez/smartstation.focusdmt.com/resources/views/Frontend/repairingform.blade.php ENDPATH**/ ?>