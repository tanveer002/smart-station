...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			...
			<form method="post" action="<?php echo e(url('/booking-form')); ?>">
				<?php echo csrf_field(); ?>
			<ul>
				<?php if(isset($issuess)): ?>
				<?php $__currentLoopData = $issuess; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $issue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<li>
					
					<span>
						<input type="checkbox" name="issue_id[]" id="selectedIssues<?php echo e($issue->id); ?>"
						value="<?php echo e($issue->id); ?>" data-name="<?php echo e($issue->issue_name); ?>" data-price="<?php echo e($issue->issue_price); ?>"
						onclick="issue(<?php echo e($issue->id); ?>)">
					</span>
					<label for="selectedIssues<?php echo e($issue->id); ?>"><?php echo e($issue->issue_name); ?></label>

				</li>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
				<?php endif; ?>
				<input type="hidden" name="modelDetials" value="<?php echo e($modelDetials->id); ?>">
			</ul>
...
<?php echo $__env->make('Frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/waqrhafeez/smartstation.focusdmt.com/resources/views/Frontend/all_models_issues.blade.php ENDPATH**/ ?>