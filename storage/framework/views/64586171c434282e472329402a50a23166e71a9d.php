...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4 col-sm-12">
			<div class="about-box active center-block bg-blue wow zoomIn" data-wow-delay="500ms" onClick="getSeriesModals('<?php echo e($serie->id); ?>','<?php echo e($appleID); ?>')">
				<div class="about-main-icon pb-4">
					<img src="<?php echo e(asset('frontend/image/Series')); ?>/<?php echo e($serie->image); ?>">
				</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MobileRepairing\resources\views/Frontend/apple_device.blade.php ENDPATH**/ ?>