                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="p-1">
                                                                <form action="<?php echo e(route('editslider',$slider->id)); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MobileRepairing\resources\views/Dashboard/Slider/slider.blade.php ENDPATH**/ ?>