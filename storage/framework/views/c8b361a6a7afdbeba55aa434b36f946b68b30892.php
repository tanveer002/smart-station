...
<div class="container">
	<div class="row">
		...
		<div class="col-md-3 col-sm-12">
            <div class="about-box active center-block bg-blue wow zoomIn" data-wow-delay="500ms" onClick="getSeriesModals('<?php echo e($serie->id); ?>','<?php echo e($htcID); ?>')">
...
<script type="text/javascript">
	...
	function populateModals(data)
	{
		...
		data.forEach(function(val, index)
		{
			...
			html+='<div class="col-md-4 col-sm-12" onClick="redirectTo('+val.id+')">'+
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MobileRepairing\resources\views/frontend/htc_device.blade.php ENDPATH**/ ?>