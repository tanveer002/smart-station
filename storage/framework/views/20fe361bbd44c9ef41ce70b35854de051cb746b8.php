                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="p-1">
                                                                <form action="<?php echo e(route('editmodel',$model->id)); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select class="form-control" name="device_name" id="device_id" >
                                                                            ...
                                                                            <?php $__currentLoopData = $devices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($device->id); ?>" data-value="<?php echo e($device->id); ?>" required><?php echo e($device->name); ?></option>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea name="ModelDescription" parsley-trigger="change" required class="form-control"></textarea>
                                                                    </div>
...
<?php echo $__env->make('Dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Larvel Project\MobileRepairing\resources\views/Dashboard/Models/models.blade.php ENDPATH**/ ?>