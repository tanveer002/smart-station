<div class="navbar-custom">
            ...
            <div class="logo-box">
                <a href="<?php echo e(url('admin/dashboard')); ?>" class="logo text-center">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo e(asset('frontend/image/logo.jpg')); ?>" alt="" height="70">
                        
                    </span>
                    <span class="logo-sm">
                        
                        <img src="<?php echo e(asset('frontend/image/logo.jpg')); ?>" alt="" height="24">
                    </span>
                </a>
            </div>
 ...
 -->
        ...
        </div><?php /**PATH /home2/waqrhafeez/smartstation.focusdmt.com/resources/views/Dashboard/layouts/header.blade.php ENDPATH**/ ?>